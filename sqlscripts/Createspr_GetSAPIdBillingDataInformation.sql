...
/****** Object:  StoredProcedure [dbo].[spr_GetSAPIdBillingDataInformation]    Script Date: 16/07/2014 02:14:50 p.m. ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[spr_GetSAPIdBillingDataInformation]
...
BEGIN
   ...
   where StageName = '09 Cerrada ganada' and 
	 ...
	 and datosFActuracion.TELEFONO_CONTACTO_FINANCIERO__C is not null 
	  ...
	  and datosFacturacion.INCONSISTENCIA__C = 0
