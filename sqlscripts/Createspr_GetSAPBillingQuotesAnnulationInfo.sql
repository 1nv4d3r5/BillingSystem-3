...
/****** Object:  StoredProcedure [dbo].[spr_GetSAPBillingQuotesAnnulationInfo]    Script Date: 16/07/2014 02:13:13 p.m. ******/
SET ANSI_NULLS ON
GO
...
***************************************************************/
CREATE PROCEDURE [dbo].[spr_GetSAPBillingQuotesAnnulationInfo]
...
select 
      ...
      'ZCP1' as DOC_TYPE,
       ...
       1 as ITM_NUMBER,
       'ZPRM' as  COND_TYPE1,
       CONVERT(int,ROUND(cuotasFacturacion.[VALUE_AFTER__C],0)) as COND_VALUE1,
       'COP' as CURRENCY2,
       CONVERT(int,ROUND(cuotasFacturacion.[VALUE_AFTER__C],0))  as CONDVALUE1,
       'ZIVA' as COND_TYPE2,
       '16' as CONDVALUE2,
       CONVERT(int,ROUND((cuotasFacturacion.[VALUE_AFTER__C]*0.16),0))  as COND_VALUE2,
       '' as id_procuo_ctr,
       '' as itm_number_ctr,
       '' as val_per,
       '' as val_per_un,
